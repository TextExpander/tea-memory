...
Team-agreed principle (Hernán + Scott Jeide, 2026-07-23): any user/client-provided bad data to an API call should NOT be logged at error level and should return a 4xx (not 5xx). This applies generally across rest-proj, not just the share route. The proposed fix above was endorsed.
